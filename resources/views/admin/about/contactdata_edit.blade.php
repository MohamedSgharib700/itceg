        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default 12" >
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{route('contact',['contact'=> $contact->id]) }}" >
                        {{ csrf_field() }}
                     ...
                     <div class="form-group  " dir="rtl">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="sity1" value="{{$contact->title2}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <input id="text" type="text" class="form-control" name="address1" value="{{$contact->address1}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="phone1" value="{{$contact->phone1}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="email1" value="{{$contact->email1}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="url1" value="{{$contact->url1}}" >
                        ...
                        <div class="form-group  " dir="rtl">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="sity2" value="{{$contact->title3}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <input id="text" type="text" class="form-control" name="address2" value="{{$contact->address2}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="phone2" value="{{$contact->phone2}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="email2" value="{{$contact->email2}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="url2" value="{{$contact->url2}}" >
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="title3" value="{{$contact->title4}}" >
