          ...
          <div class="box">
            ...
            <!-- /.box-header -->
              ...
              <table id="example2" class="table table-bordered table-hover pull-right">
                ...
                <tr>
                <td><a href="client_change/<?php echo e($reports->id); ?>/delete" class="btn btn-danger">حذف</a></td>
                  <td><a href="client_edit/<?php echo e($reports->id); ?>/edit" class="btn btn-success">تعديل</a></td>
                  <td><?php echo e($reports->number1); ?></td>
                  <td><?php echo e($reports->sub_text1); ?></td>
                  <td><?php echo e($reports->text1); ?></td>
                ...
                <td><a href="client_change/<?php echo e($reports->id); ?>/delete" class="btn btn-danger">حذف</a></td>
                  <td><a href="client_edit/<?php echo e($reports->id); ?>/edit" class="btn btn-success">تعديل</a></td>
                  <td><?php echo e($reports->number2); ?></td>
                  <td><?php echo e($reports->sub_text2); ?></td>
                  <td><?php echo e($reports->text2); ?></td>
                  
                </tr>

                  <tr>
                <td><a href="reports_change/<?php echo e($reports->id); ?>/delete" class="btn btn-danger">حذف</a></td>
                  <td><a href="client_edit/<?php echo e($reports->id); ?>/edit" class="btn btn-success">تعديل</a></td>
                  <td><?php echo e($reports->number3); ?></td>
                  <td><?php echo e($reports->sub_text3); ?></td>
                  <td><?php echo e($reports->text3); ?></td>
                ...
                <td><a href="client_change/<?php echo e($reports->id); ?>/delete" class="btn btn-danger">حذف</a></td>
                  <td><a href="client_edit/<?php echo e($reports->id); ?>/edit" class="btn btn-success">تعديل</a></td>
                  <td><?php echo e($reports->number4); ?></td>
                  <td><?php echo e($reports->sub_text4); ?></td>
                  <td><?php echo e($reports->text4); ?></td>
