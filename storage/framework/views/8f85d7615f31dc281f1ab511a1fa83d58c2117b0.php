 ...
 <div class="content-wrapper">
    ...
    <section align="right" class="content">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
              ...
              <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                <td><a href="reports_change/<?php echo e($report->id); ?>/delete" class="btn btn-danger">حذف</a></td>
                  <td><a href="reports_edit/<?php echo e($report->id); ?>/edit" class="btn btn-success">تعديل</a></td>
                  <td><?php echo e($report->number); ?></td>
                  <td><?php echo e($report->sub_text); ?></td>
      ...
      <form action="<?php echo e(url('reports_show/add')); ?>" method="post" >
