...
<div class="box-body">
            <h3 class="box-title">عرض الخدمات</h3>
              ...
              <table id="example2" class="table table-bordered table-hover pull-right">
                ...
                <tr>
                  <td><?php echo $content->content1; ?></td>
                  <td><?php echo e($content->title1); ?></td>
                  <td>1</td> 
                </tr>

                <tr>
                  
                  <td><?php echo $content->content2; ?></td>
                  <td><?php echo e($content->title2); ?></td>
                  <td>2</td> 
                </tr>

                <tr>
                  
                  <td><?php echo $content->content3; ?></td>
                  <td><?php echo e($content->title3); ?></td>
                  <td>3</td> 
                </tr>

                <tr>
                  
                  <td><?php echo $content->content4; ?></td>
                  <td><?php echo e($content->title4); ?></td>
                  <td>4</td> 
                </tr>
 ...
 <td align="center"><a href="content/<?php echo e($content->id); ?>/edit" class="btn btn-success">تعديل</a></td>
