@extends('admin.layouts.layout')
 ...
 <div class="content-wrapper">
    ...
    <section align="right" class="content">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
              ...
              <table id="example2" class="table table-bordered table-hover pull-right">
                ...
                <tr>
                <td><a href="report_change/{{$report->id}}/delete" class="btn btn-danger">حذف</a></td>
                  <td><a href="report_edit/{{$report->id}}/edit" class="btn btn-success">تعديل</a></td>
                  <td>{{$report->number1}}</td>
                  <td>{{$report->text1}}</td>  
                </tr>
                @endforeach
      ...
      <form action="{{url('report_show/add')}}" method="post" >
       {{csrf_field()}}
