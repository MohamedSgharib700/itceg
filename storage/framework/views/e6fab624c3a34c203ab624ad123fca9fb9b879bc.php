        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default 12" >
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype= multipart/form-data method="POST" action="<?php echo e(route('servicesRequest',['servicesRequest'=> $servicesRequest->id])); ?>" >
                        ...
                        <div class="form-group  " dir="rtl">
                           ...
                           <div class="form-group<?php echo e($errors->has('sup_title') ? ' has-error' : ''); ?>">
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" required name="name" value="<?php echo e($servicesRequest->title); ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group<?php echo e($errors->has('sup_title') ? ' has-error' : ''); ?>">
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" required="" name="sub_name" value="<?php echo e($servicesRequest->sub_title); ?>" >
                                <?php if($errors->has('sup_title')): ?>
                                  <span class="help-block">
                                   <strong><?php echo e($errors->first('sup_title')); ?></strong>
                                   </span>
                        ...
                        <div class="form-group">
                            <label for="text" class="col-md-4 control-label pull-right">الصوره</label>
                              <div class="form-group<?php echo e($errors->has('sup_title') ? ' has-error' : ''); ?>">
                            <div class="col-md-6">
                                <input id="text" type="file" class="form-control"  name="image" value="<?php echo e(old('image')); ?>" >
                                <?php if($errors->has('sup_title')): ?>
                                  <span class="help-block">
                                   <strong><?php echo e($errors->first('sup_title')); ?></strong>
                                   </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group<?php echo e($errors->has('sup_title') ? ' has-error' : ''); ?>">
                            <div class="col-md-6">
                                <textarea class="textarea " name="detils" required placeholder="Place some text here" style="width: 100%; height: 200px; font-size:    14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo e($servicesRequest->detils); ?></textarea>
                                <?php if($errors->has('sup_title')): ?>
                                  <span class="help-block">
                                   <strong><?php echo e($errors->first('sup_title')); ?></strong>
                                   </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" required name="urlTitle" value="<?php echo e($servicesRequest->urlTitle); ?>" >
