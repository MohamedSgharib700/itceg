...
<html>
	<head>
		...
		<title>{{$headers->site_titles}}</title>
		<meta name="title" content="{{$headers->metaTitles}}" />
						...
						<div class="header-row">
							<div class="header-column">
								<div class="header-logo">
									...
									<a href="{{url('/')}}" >
										<img alt="ITceg" width="200" height="70" src="{{asset('logos/'.$headers->logo)}}">
									</a>
								</div>
							</div>
							<div class="header-column">
