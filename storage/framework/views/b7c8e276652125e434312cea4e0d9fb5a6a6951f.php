 ...
 <div class="content-wrapper">
  ...
  <div class="col-sm-2 col-md-4 pull-right"  >
    <div class="">
     <td> <img width="200" height="60" src="<?php echo e(asset('sliders/'.$slider->slider_name)); ?>" > </td>
      <div class="caption">
        <th></th>
        <p><a href="packages_change/<?php echo e($slider->id); ?>/delete" class="btn btn-danger pull-right">حذف</a></p>
      </div>
    </div>
  </div>
 
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<form enctype="multipart/form-data" action="<?php echo e(url('packages_change')); ?>" method="post" >
<?php echo e(csrf_field()); ?>
 ...
 <div></div>
  ...
  <tr>
    ...
    <td><input type="file" name="slider_change" max="30000"  value="" /></td>
    <th> : اختر الصوره</th>
  </tr>
