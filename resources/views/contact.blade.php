					...
					<div class="container">
						...
						<div class="row mt-xl">
							...
							<div class="col-md-8 col-md-offset-2 mt-xlg">
								<h1 class="mt-xlg font-weight-semibold text-uppercase">{{$contact->title1}}</h1>
								<p class="mb-none lead">{{$contact->contact}}</p>
							</div>
						</div>
						<div class="row mt-lg">
							<div class="col-md-10 col-md-offset-1">
								<div class="row mt-lg align-left">
									<div class="col-md-5 mb-lg">
										<h4 class="mt-md mb-none">{{$contact->title2}}</h4>
										<ul class="list list-icons mt-xlg">
											<li><i class="fa fa-map-marker"></i> <strong>Address:</strong> {{$contact->address1}}</li>
											<li><i class="fa fa-phone"></i> <strong>Phone:</strong> {{$contact->phone1}}</li>
											<li><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="{{$contact->url1}}">{{$contact->email1}}</a></li>
										</ul>
									</div>
									<div class="col-md-5 col-md-offset-2 mb-lg">
										<h4 class="mt-md mb-none">{{$contact->title3}}</h4>
										<ul class="list list-icons mt-xlg">
											<li><i class="fa fa-map-marker"></i> <strong>Address:</strong> {{$contact->address2}}</li>
											<li><i class="fa fa-phone"></i> <strong>Phone:</strong> {{$contact->phone2}}</li>
											<li><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="{{$contact->url2}}">{{$contact->email2}}</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="row mt-lg">
								<div class="col-md-10 col-md-offset-1 center">
									...
									<h2 class="mb-none mt-xl font-weight-semibold">{{$contact->title4}}</h2>
