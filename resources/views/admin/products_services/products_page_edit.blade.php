        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default 12" >
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype= multipart/form-data method="POST" action="{{route('products',['products'=> $products->id]) }}" >
                        {{ csrf_field() }}
                             @if(count($errors)>0)
                        ...
                        <div class="form-group  " dir="rtl">
                          ...
                          <div class="form-group{{ $errors->has('sup_title') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" required name="name" value="{{$products->title}}" >
                        ...
                        <div class="form-group">
                            <label for="text" class="col-md-4 control-label pull-right">الاسم الفرعي</label>
                             <div class="form-group{{ $errors->has('sup_title') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" required name="sub_name" value="{{$products->sub_title}}" >
                                @if ($errors->has('sup_title'))
                              <span class="help-block">
                             <strong>{{ $errors->first('sup_title') }}</strong>
                              </span>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group{{ $errors->has('sup_title') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                <input id="text" type="file" class="form-control"  name="image" value="{{$products->image}}" >
                                 @if ($errors->has('sup_title'))
                              <span class="help-block">
                             <strong>{{ $errors->first('sup_title') }}</strong>
                              </span>
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group{{ $errors->has('sup_title') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                <textarea class="textarea " name="detil" required ="Place some text here" style="width: 100%; height: 200px; font-size:    14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$products->detils}}</textarea>
                                @if ($errors->has('sup_title'))
                              <span class="help-block">
                             <strong>{{ $errors->first('sup_title') }}</strong>
                              </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" required name="urlTitle" value="{{$products->custom_url}}" >
