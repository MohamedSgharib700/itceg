        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default 12" >
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{route('reports',['reports'=> $report->id]) }}" >
                        {{ csrf_field() }}
                        @if(count($errors)>0)
                        ...
                        <div class="form-group  " dir="rtl">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="title" value="{{$report->text}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="sub_title" value="{{$report->sub_text}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="number" value="{{$report->number}}" >
