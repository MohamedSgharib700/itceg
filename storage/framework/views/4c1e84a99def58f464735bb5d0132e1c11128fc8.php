    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default 12" >
                ...
                <form class="form-horizontal"  method="POST" action="<?php echo e(route('customers',['customer'=> $customers->id])); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group  " dir="rtl">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="file" class="form-control" name="image_change" value="<?php echo e(old('image')); ?>" >
