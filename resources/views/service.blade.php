...
<div role="main" class="main">
				...
				<section class="section section-default section-footer section-color-custom mt-none">
					<div class="container">
						<div class="row mt-xl">
							<div class="col-md-4">
								<img width="300" height="400" style="height: 300px; width:500px;" class="img-responsive appear-animation" src="{{asset('servicesAdd/'.$services->image)}}" alt="layout styles" data-appear-animation="fadeInLeft">
							</div>
							<div class="col-md-7 col-md-offset-1">
								<h2 class="mb-xs mt-xl font-weight-semibold">{{$services->title}}.</h2>
