        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default 12" >
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{route('report',['report'=> $report->id]) }}" >
                        {{ csrf_field() }}
                        @if(count($errors)>0)
                        ...
                        <div class="form-group  " dir="rtl">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="title" value="{{$report->text1}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="count" value="{{$report->number1}}" >
