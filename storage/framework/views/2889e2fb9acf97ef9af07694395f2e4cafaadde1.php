...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo e(url('adminpanel')); ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>القائمه</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">صفحة التحكم</span>
    </a>
        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('admin/dist/img/user3-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('admin/dist/img/user4-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('img/if_user1_49390.png')); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs">مشرف الصفحه</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo e(asset('img/if_user1_49390.png')); ?>" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> مسجل الان</a>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">قائمة الصفحات</li>
        <li class="
        ">
        ...
        <li class="treeview">
          <a href="">
            ...
            <span>التحكم في محتوي الصفحات</span>
        ...
        <li class="treeview">
          <a href="">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-rhtig"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('logo_show')); ?>"><i class="fa fa-circle-o"></i>الشعار</a></li>
            <li><a href="<?php echo e(url('slides_change')); ?>"><i class="fa fa-circle-o"></i> الشرائح الرئيسيه</a></li>
            <li><a href="<?php echo e(url('services_show')); ?>"><i class="fa fa-circle-o"></i> الخدمات</a></li>
            <li><a href="<?php echo e(url('about_change')); ?>"><i class="fa fa-circle-o"></i> تعريف الشركه</a></li>
            <li><a href="<?php echo e(url('client_change')); ?>"><i class="fa fa-circle-o"></i> عرض العملاء</a></li>
            <li><a href="<?php echo e(url('reports_change')); ?>"><i class="fa fa-circle-o"></i> التقارير</a></li>
            <li><a href="<?php echo e(url('footer_change')); ?>"><i class="fa fa-circle-o"></i> الفوتر</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu"> 
            <li><a href="<?php echo e(url('aboutUs_show')); ?>"><i class="fa fa-circle-o"></i> عن الشركه</a></li>
            <li><a href="<?php echo e(url('report_change')); ?>"><i class="fa fa-circle-o"></i> التقارير</a></li>
            <li><a href="<?php echo e(url('maneger_change')); ?>"><i class="fa fa-circle-o"></i> عرض المديرين</a></li>
            <li><a href="<?php echo e(url('customers_change')); ?>"><i class="fa fa-circle-o"></i> عرض العملاء</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('products_page')); ?>"><i class="fa fa-circle-o"></i> المنتجات</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('services_page')); ?>"><i class="fa fa-circle-o"></i> الخدمات</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('contactdata_change')); ?>"><i class="fa fa-circle-o"></i>بيانات الاتصال</a></li>
          </ul>
        </li>
        ...
        <li>
          <a href="<?php echo e(url('messages_show')); ?>">
  ...
  <footer class="main-footer">
    ...
    <strong>©Copy right .Itceg &copy; 2017 .</strong> All rights
    reserved.
  </footer>
...
<!-- FastClick -->
<script src="<?php echo e(asset('admin/admin/bower_components/fastclick/lib/fastclick.js')); ?>"></script>
<!-- AdminLTE App -->
