            ...
            <h5 class="box-title"><?php echo e($title->sub_title); ?></h5>
              ...
              <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td><a href="client_change/<?php echo e($client->id); ?>/delete" class="btn btn-danger">حذف</a></td>
                  ...
                  <td><img width="80" height="60" src="<?php echo e(asset('clientAdd/'.$client->image)); ?>"></td>
...
<form action="<?php echo e(url('client_show/add')); ?>" method="post" enctype="multipart/form-data">
