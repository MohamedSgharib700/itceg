            ...
            <h3 class="box-title">عرض الشرائح</h3>
              ...
              <?php $__currentLoopData = $slide; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td><a href="slides_change/<?php echo e($slide->id); ?>/delete" class="btn btn-danger">حذف</a></td>
                  <td><a href="slidess/<?php echo e($slide->id); ?>/edit" class="btn btn-success">تعديل</a></td>
...
<?php echo e(csrf_field()); ?>  
 ...
 <table width="800" height="600" border="0" align="right">
  ...
  <tr>
    ...
    <div class="form-group<?php echo e($errors->has('slides_change') ? ' has-error' : ''); ?>">
    <td><input type="file" name="slides_change" max="30000"  value="" required /></td>
     <?php if($errors->has('slides_change')): ?>
           <span class="help-block">
            <strong><?php echo e($errors->first('slides_change')); ?></strong>
           </span>
        <?php endif; ?>
    <th> : اختر الشرائح</th>
  </tr>
