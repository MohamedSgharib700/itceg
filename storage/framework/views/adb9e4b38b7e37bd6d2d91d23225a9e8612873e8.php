					...
					<div class="container">
						<div class="row mt-xl">
							<div class="col-md-4">
							 ...
							 <?php echo e(asset('productsAdd/'.$products->image)); ?>" alt="layout styles" data-appear-animation="fadeInLeft">
							</div>

							<div class="col-md-7 col-md-offset-1">
								<h2 class="mb-xs mt-xl font-weight-semibold"><?php echo e($products->title); ?>.</h2>
								<div class="divider divider-primary divider-small mb-xl">
									<hr>
								</div>
								<p class="lead">
									<?php echo $products->detils; ?>
