				...
				<div class="container">
					<ul class="nav nav-pills sort-source mt-xl mb-xl" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*'}">
					  ...
					  <?php $__currentLoopData = $catalogue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catalogue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<li data-option-value=".<?php echo e($catalogue->catalogue_name); ?>" class=""><a href="#"><?php echo e($catalogue->catalogue_name); ?></a></li>
						 ...
						 <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							 <?php 
							  ...
							  ?>
								...
								<li class="col-md-4 isotope-item m-none p-none <?php echo e($filter->catalogue_name); ?>">
								
									<div class="portfolio-item m-none">
										<a href="<?php echo e(route('showService',['service'=>$service->custom_url])); ?>">
											<span class="thumb-info thumb-info-centered-info thumb-info-no-borders m-none">
												<span class="thumb-info-wrapper">
													<img style="height: 300px; width:500px;"  src="<?php echo e(asset('servicesAdd/'.$service->image)); ?>" class="img-responsive" alt="">
													<span class="thumb-info-title">
														<span class="thumb-info-inner"><?php echo e($service->title); ?></span>
														<span class="thumb-info-type"><?php echo e($service->sub_title); ?></span>
													</span>
