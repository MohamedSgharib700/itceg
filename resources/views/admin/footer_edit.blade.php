                ...
                <div class="panel-body">
                   <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('footer',['footer'=> $footer->id]) }}" >
                        ...
                        <div class="form-group  " dir="rtl">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="url_title" value="{{$footer->link_name}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="url_linke" value="{{$footer->link_url}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="url_face" value="{{$footer->url_face}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="url_twitter" value="{{$footer->url_twitter}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="url_linkedin" value="{{$footer->url_linkedin}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="copy_right" value="{{$footer->copy_right}}" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <input id="text" type="" class="form-control" name="phone" value="{{$footer->Connection}}" >
